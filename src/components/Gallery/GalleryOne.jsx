        ...
        <div className="gallery-area">
            <div className="container th-container shape-mockup-wrap">
                <div className="title-area text-center">
                    <span className="sub-title" style={{ color: "var(--theme-color2)", fontWeight: "bold", display: "inline-block", marginBottom: "12px" }}>Haciendo de tus viajes, grandes recuerdos</span>
                    <h2 className="sec-title">Viajes recientes</h2>
                </div>
